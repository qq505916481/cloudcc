...
class Page
{
    ...
    private function endPage()
    {
        ...
        return '<li><a href="'.$this->url.$this->pageAmount.'">尾页</a></li>';
    }
    ...
    {
        if($this->currentPage == 1) return;
        return '<li><a href="'.$this->url.( $this->currentPage - 1 ).'">上一页</a></li>';
    }
    ...
    {
        if($this->currentPage == $this->pageAmount) return;
        return '<li><a href="'.$this->url.( $this->currentPage + 1 ).'">下一页</a></li>';
    }
    ...
    private function pageNumber()
    {
        ...
        if($this->pageAmount > ($this->offset * 2 + 1))
        {
            ...
            return $left.'<li class="active"><a href="'.$this->url.$this->currentPage.'">'.$this->currentPage.'</a></li>'.$right;
        }
        else
        {
            $allLink='';
            ...
            {
                 $allLink.='<li class="'.($j == $this->currentPage?$this->classHere:'').'"><a href="'.$this->url.$j.'" >'.$j.'</a></li>';
            }
            return $allLink;
        }
    }
