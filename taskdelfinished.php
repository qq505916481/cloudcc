...
$sql = "UPDATE `".DB_PRE."task` SET `waitdelete` = 1 WHERE endtime < ".time();
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
	  ...
	  <h3>所有已经完成的任务已经成功删除.</h3>
	  <small id="ShowDiv">Powered by Angelic47. 系统将在3秒后将会转向任务界面</small>
	  </div>
		<script language="javascript">
			...
			{ 
			document.getElementById('ShowDiv').innerHTML = 'Powered by Angelic47. 系统将在'+num+'秒后将会转向任务界面' ;
